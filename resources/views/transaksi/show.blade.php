<x-app>
    ...
    <ul class="list-group mb-3">
        ...
        <li class="list-group-item"><strong>Tanggal:</strong>
            {{ \Carbon\Carbon::parse($transaksi->tanggal_transaksi)->format('d F Y') }}</li>
        ...
        <li class="list-group-item"><strong>Total Harga:</strong>
            Rp{{ number_format($transaksi->total_harga, 0, ',', '.') }}</li>
    ...
    @if ($transaksi->pembeli)
        ...
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item"><strong>Created:</strong>
                {{ $transaksi->pembeli->created_at->format('d F Y H:i:s') }}</li>
        </ul>
    @endif
